...
fn gen_tx_eip2930_ops(
    ...
    state.push_copy(
        ...
        CopyEvent {
            ...
            src_type: CopyDataType::TxAccessListAddresses,
            src_id: tx_id.clone(),
            dst_addr: 0,
            dst_type: CopyDataType::RwAccessListAddresses,
            dst_id: tx_id.clone(),
            log_id: None,
            rw_counter_start,
            // TODO
    ...
    state.push_copy(
        ...
        CopyEvent {
            ...
            src_type: CopyDataType::TxAccessListStorageKeys,
            src_id: tx_id.clone(),
            dst_addr: 0,
            dst_type: CopyDataType::RwAccessListStorageKeys,
            dst_id: tx_id,
            log_id: None,
            rw_counter_start,
            // TODO
