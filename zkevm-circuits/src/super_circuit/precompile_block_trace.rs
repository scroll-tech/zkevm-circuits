...
pub(crate) fn block_precompile_invalid_ec_add() -> BlockTrace {
    ...
    let bytecode_ec_add_oor_p = PrecompileCallArgs {
        ...
        setup_code: bytecode! {
            // p_x = p + 1
            PUSH1(0x30644E72E131A029B85045B68181585D97816A916871CA8D3C208C16D87CFD48)
            PUSH1(0x00)
            MSTORE
            // p_y = p + 2
            PUSH1(0x30644E72E131A029B85045B68181585D97816A916871CA8D3C208C16D87CFD49)
            PUSH1(0x20)
            MSTORE
            // q_x = 1
            PUSH1(0x01)
    ...
    TestContext::<5, 4>::new(
        ...
        |accs| {
            ...
            accs[1]
                .address(addr_b)
                .balance(Word::from(1u64 << 20))
                .code(bytecode_ec_add_noc_p);
            accs[2]
                .address(addr_c)
                .balance(Word::from(1u64 << 20))
                .code(bytecode_ec_add_noc_q);
            accs[3]
                .address(addr_d)
                .balance(Word::from(1u64 << 20))
                .code(bytecode_ec_add_oor_p);
            accs[4]
                .address(addr_e)
                .balance(Word::from(1u64 << 20))
                .code(bytecode_ec_add_oor_q);
        },
        |mut txs, accs| {
            txs[0]
                .from(wallet_a.clone())
