...
pub(crate) enum Lookup<F> {
    ...
    EccTable {
        ...
        is_valid: Expression<F>,
        arg1_limbs: [Expression<F>; 2],
        arg2_limbs: [Expression<F>; 2],
        arg3_limbs: [Expression<F>; 2],
        arg4_limbs: [Expression<F>; 2],
        input_limbs: [Expression<F>; 2],
        output1_limbs: [Expression<F>; 2],
        output2_limbs: [Expression<F>; 2],
    },
    PowOfRandTable {
