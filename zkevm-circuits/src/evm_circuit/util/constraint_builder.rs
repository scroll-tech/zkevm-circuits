...
impl<'a, F: Field> EVMConstraintBuilder<'a, F> {
    ...
    // Memory
    // TODO: last to update memory lookup as we apply memory word lookup feature
    ...
    pub(crate) fn ecc_table_lookup(
        ...
        is_valid: Expression<F>,
        arg1: Word<Expression<F>>,
        arg2: Word<Expression<F>>,
        arg3: Word<Expression<F>>,
        arg4: Word<Expression<F>>,
        input: Word<Expression<F>>,
        output1: Word<Expression<F>>,
        output2: Word<Expression<F>>,
    ) {
        self.add_lookup(
            "ecc table",
            Lookup::EccTable {
